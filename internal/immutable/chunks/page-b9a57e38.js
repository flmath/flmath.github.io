    ...
    <div class="row">
      ...
      <div class="col-xs-12 col-sm-12 col-md-12">
        ...
        <header id="pageHeader">
          ...
          <h1 class="title">Matrices in Erlang: Growth Projections</h1>
...
<div class="pj-input pj-fold fold-show">
...
<span class="n">warnings</span><span class="o">.</span><span class="n">filterwarnings</span><span class="p">(</span><span class="s2">&quot;ignore&quot;</span><span class="p">,</span> <span class="n">category</span><span class="o">=</span><span class="ne">UserWarning</span><span class="p">,</span> <span class="n">message</span><span class="o">=</span><span class="s2">&quot;.*InterpolationWarning.*&quot;</span><span class="p">)</span>
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      <th rowspan="5" valign="top">set_value</th>
...
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">MinTable</span> <span class="o">=</span> <span class="p">(</span><span class="n">LoadedTable</span><span class="o">.</span><span class="n">groupby</span><span class="p">([</span><span class="s1">&#39;Operation&#39;</span><span class="p">,</span><span class="s1">&#39;Representation&#39;</span><span class="p">])</span>
       <span class="o">.</span><span class="n">agg</span><span class="p">(</span><span class="n">Max</span><span class="o">=</span><span class="p">(</span><span class="s1">&#39;ExecutionTime&#39;</span><span class="p">,</span> <span class="s1">&#39;max&#39;</span><span class="p">))</span>  <span class="p">)</span>
<span class="n">MinTable</span>
</pre></div>
...
<span class="n">Statistic</span><span class="o">.</span><span class="n">apply</span><span class="p">(</span><span class="k">lambda</span> <span class="n">x</span><span class="p">:</span> <span class="n">stat</span><span class="o">.</span><span class="n">kpss</span><span class="p">(</span><span class="n">x</span><span class="p">[</span><span class="s1">&#39;dg&#39;</span><span class="p">],</span> <span class="n">regression</span><span class="o">=</span><span class="s1">&#39;c&#39;</span><span class="p">)[</span><span class="mi">0</span><span class="p">:</span><span class="mi">2</span><span class="p">],</span> <span class="n">axis</span><span class="o">=</span><span class="mi">1</span><span class="p">)</span><span class="o">.</span><span class="n">apply</span><span class="p">(</span><span class="n">pd</span><span class="o">.</span><span class="n">Series</span><span class="p">)</span>
</pre></div>
...
<span class="n">Statistic</span><span class="p">[[</span><span class="s1">&#39;deg_int_slope&#39;</span><span class="p">]]</span> <span class="o">=</span> <span class="n">np</span><span class="o">.</span><span class="n">ceil</span><span class="p">(</span><span class="n">Statistic</span><span class="p">[[</span><span class="s1">&#39;deg_slope&#39;</span><span class="p">]])</span>
<span class="n">Statistic</span><span class="p">[[</span><span class="s1">&#39;dg_end&#39;</span><span class="p">]]</span> <span class="o">=</span> <span class="n">Statistic</span><span class="o">.</span><span class="n">aggregate</span><span class="p">(</span><span class="k">lambda</span> <span class="n">x</span><span class="p">:</span> <span class="n">np</span><span class="o">.</span><span class="n">linalg</span><span class="o">.</span><span class="n">norm</span><span class="p">(</span><span class="n">x</span><span class="p">[</span><span class="s1">&#39;dg&#39;</span><span class="p">][</span><span class="o">-</span><span class="mi">4</span><span class="p">:]),</span><span class="n">axis</span><span class="o">=</span><span class="mi">1</span><span class="p">)</span><span class="o">.</span><span class="n">apply</span><span class="p">(</span><span class="n">pd</span><span class="o">.</span><span class="n">Series</span><span class="p">)</span>
<span class="n">Statistic</span><span class="o">.</span><span class="n">loc</span><span class="p">[</span> 
        <span class="p">(</span><span class="n">Statistic</span><span class="p">[</span><span class="s1">&#39;spearmanr_pval&#39;</span><span class="p">]</span><span class="o">&lt;</span><span class="mf">0.05</span><span class="p">)</span> <span class="o">&amp;</span> <span class="p">(</span><span class="n">Statistic</span><span class="p">[</span><span class="s1">&#39;spearmanr_r&#39;</span><span class="p">]</span><span class="o">&lt;</span><span class="mf">0.0</span><span class="p">),</span> 
        <span class="p">[</span><span class="s1">&#39;deg_int_slope&#39;</span><span class="p">,</span> <span class="s1">&#39;spearmanr_r&#39;</span><span class="p">,</span> <span class="s1">&#39;spearmanr_pval&#39;</span><span class="p">,</span> <span class="s1">&#39;reg_slope&#39;</span><span class="p">,</span> <span class="s1">&#39;reg_pval&#39;</span><span class="p">,</span> <span class="s1">&#39;dg_end&#39;</span><span class="p">]]</span>
</pre></div>
...
<\/script>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function() {
        ...
        window.processTokens(tokenSep="|O_O|");
        window.processHeaders(tokenSep="|O_O|");
