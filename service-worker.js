const u = [
  ...
  "/internal/immutable/start-c2b9814d.js",
  "/internal/immutable/components/pages/_layout.svelte-b419b594.js",
  "/internal/immutable/assets/_layout-31720baa.css",
  "/internal/immutable/components/pages/_error.svelte-6e601075.js",
  ...
  "/internal/immutable/components/pages/posts/_page.svelte-6d6c4af2.js",
  ...
  "/internal/immutable/chunks/singletons-3248c289.js",
  ...
  "/internal/immutable/chunks/stores-db215052.js",
  ...
  "/internal/immutable/chunks/0-adec631f.js",
  "/internal/immutable/chunks/1-76e372f5.js",
  ...
  "/internal/immutable/chunks/6-dec1210c.js",
  ...
  "/manifest.json",
  "/robots.txt"
], l = "1724624084351", s = self, m = `cache${l}`, c = u.concat(o), p = new Set(c);
s.addEventListener("install", (e) => {
  e.waitUntil(
    caches.open(m).then((t) => t.addAll(c)).then(() => {
      s.skipWaiting();
    })
  );
});
...
s.addEventListener("fetch", (e) => {
  if (e.request.method !== "GET" || e.request.headers.has("range"))
    return;
  const t = new URL(e.request.url), a = t.protocol.startsWith("http"), n = t.hostname === self.location.hostname && t.port !== self.location.port, i = t.host === self.location.host && p.has(t.pathname), r = e.request.cache === "only-if-cached" && !i;
  a && !n && !r && e.respondWith(
